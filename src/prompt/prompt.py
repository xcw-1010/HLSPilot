ALGO_NAME = "BFS"
FUNCTION_DESCRIPTION = "bfs algorithm"
REF_OPT_ALGO = "XXX"

SYSTEM_PROMPT = \
"""
You are an FPGA engineer and you are designing an accelerator using HLS(high-level-synthesis).
Here is a software code for {ALGO_NAME}, which serially implements the {FUNCTION_DESCRIPTION}. Your goal is to optimize this code to make it work more efficiently on FPGA.
"""
