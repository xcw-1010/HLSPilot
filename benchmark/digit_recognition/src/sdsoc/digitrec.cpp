...
{
#pragma HLS INTERFACE m_axi port=global_training_set offset=slave bundle=gmem0
#pragma HLS INTERFACE m_axi port=global_test_set offset=slave bundle=gmem1
#pragma HLS INTERFACE m_axi port=global_results offset=slave bundle=gmem2
